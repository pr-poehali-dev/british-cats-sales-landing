...
const MODULES = [
  ...
  { n: '15', t: 'Экзамен и сертификат', d: 'Финальный проект, защита перед кураторами и сертификат школы. Бонус: уроки по чат-ботам Salebot.' },
];
      ...
      <div className="wrap">
        <div className="prog-layout">
          <div className="prog-sticky">
            ...
            <Reveal as="h2" className="sec-title grad-text">15 модулей.<br />Ноль воды.</Reveal>
