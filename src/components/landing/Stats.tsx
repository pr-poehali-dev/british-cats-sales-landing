...
const STATS = [
  ...
  { to: 85, suffix: '%', label: 'доводимость до результата — против 10–15% у онлайн-курсов' },
];

const TRUST = ['Опора России', 'Мой Бизнес', 'Росмолодёжь', 'Штаб общественной поддержки', 'ПАО «Дальприбор»', 'Бизнес Завтрак', 'Пасифик Медиа', 'VLPACIFIC'];
