...
const PLANS = [
  {
    badge: 'Выбор большинства', badgeO: false, hot: false,
    ...
    btn: 'Взять базу', ghost: true,
  },
  {
    badge: null as string | null, badgeO: false, hot: true,
    ...
    btn: 'Обсудить обучение', ghost: false,
  },
  {
