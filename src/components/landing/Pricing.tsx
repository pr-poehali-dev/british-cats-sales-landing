...
const PLANS = [
  {
    ...
    tag: 'ДЛЯ СТАРТА', name: 'СТАРТ', sum: 'от 12 500 ₽', per: '/ МЕСЯЦ В РАССРОЧКУ',
    ...
    btn: 'Взять СТАРТ', ghost: true,
  },
  {
    badge: 'Выбор большинства', badgeO: false, hot: true,
    tag: 'С ПОДДЕРЖКОЙ', name: 'БАЗА', sum: 'по консультации', per: 'РАССРОЧКА И КРЕДИТ ДОСТУПНЫ',
    feats: ['Всё из тарифа СТАРТ', 'Расширенная обратная связь кураторов', 'Разборы твоих проектов на занятиях', 'Дополнительные мастермайнды потока', 'Приоритетные места в классе'],
  ...
  },
  {
    ...
    feats: ['Всё из тарифа БАЗА', 'Личный куратор на весь курс', 'Индивидуальный трек под твой бизнес', 'Разбор воронки и продукта 1-на-1', 'Доступ к Сергею и команде школы'],
