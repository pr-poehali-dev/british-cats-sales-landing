...
const TL = [
  ...
  { y: '2019', h: 'Super-SMM и первые курсы', p: 'Собственные продукты автоматизации лидогенерации.' },
  { y: '2021', h: 'Переезд во Владивосток', p: 'Воркшопы по нейросетям для предпринимателей Приморья.' },
  { y: '2024', h: 'Школа «Хакни Нейросети»', p: 'Первая живая школа ИИ на Дальнем Востоке.' },
  { y: '2026', h: '«Опора России» и форум «Без Ширмы»', p: 'Партнёрство и ИИ-форум с участием правительства Приморья.' },
