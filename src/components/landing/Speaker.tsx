...
const TL = [
  ...
  { y: '2022', h: 'Школа «Хакни Нейросети»', p: 'Первая живая школа ИИ на Дальнем Востоке.' },
  { y: '2024', h: '«Опора России» и форум «Без Ширмы»', p: 'Партнёрство и ИИ-форум с участием правительства Приморья.' },
